...
const appCss = "/assets/styles-CXZIdOw3.css";
...
const $$splitComponentImporter$6 = () => import("./admin.index-C0Z_KcPW.mjs");
const Route$6 = createFileRoute("/admin/")({
  component: lazyRouteComponent($$splitComponentImporter$6, "component")
});
const $$splitComponentImporter$5 = () => import("./admin.projects-Ec53na8x.mjs");
const Route$5 = createFileRoute("/admin/projects")({
  component: lazyRouteComponent($$splitComponentImporter$5, "component")
});
const $$splitComponentImporter$4 = () => import("./admin.login-lxKgGtQx.mjs");
const Route$4 = createFileRoute("/admin/login")({
  component: lazyRouteComponent($$splitComponentImporter$4, "component")
});
const $$splitComponentImporter$3 = () => import("./admin.leads-DD1VqT8b.mjs");
const Route$3 = createFileRoute("/admin/leads")({
  component: lazyRouteComponent($$splitComponentImporter$3, "component")
});
const $$splitComponentImporter$2 = () => import("./admin.invoices-DefLLRCJ.mjs");
const Route$2 = createFileRoute("/admin/invoices")({
  component: lazyRouteComponent($$splitComponentImporter$2, "component")
});
const $$splitComponentImporter$1 = () => import("./admin.clients-BB7DGYRs.mjs");
const Route$1 = createFileRoute("/admin/clients")({
  component: lazyRouteComponent($$splitComponentImporter$1, "component")
});
const $$splitComponentImporter = () => import("./admin.automation-Cp3v85Jf.mjs");
