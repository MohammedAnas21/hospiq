...
const LifeBuoy = createLucideIcon("life-buoy", __iconNode$y);
const __iconNode$x = [
  [
    "path",
    {
...
const MousePointerClick = createLucideIcon("mouse-pointer-click", __iconNode$p);
const __iconNode$o = [
